...
const about = [
      ...
      "When I'm not at the computer, I'm usually hanging out with my girlfriend and the two dogs of ours, playing videogames, reading or trying to learn about something. I love motorcyles, science, technology, the tenacity of the human siprit... and of course...</br> <span style='color: white;'><a class='cursor-voyager relative group inline-block' href='https://voyager.jpl.nasa.gov/golden-record/golden-record-cover/'>the Voyagers and their Golden Records!<span class='block h-1 bg-amber-400 transform scale-x-100 sm:scale-x-0 group-hover:scale-x-100 transition-transform origin-left ease-out duration-200'></span></a></span>"
];
