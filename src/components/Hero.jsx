...
const Hero = () => {
  ...
  return (
    ...
    >
      ...
      >
        <div className='parallax__content relative ml-4 top-[8%] sm:ml-8 sm:top-[10%] lg:top-[6%] w-full mx-auto lg:pl-[6rem] lg:pr-[6rem] xl:pl-[10rem] xl:pr-40 2xl:px-40 3xl:px-60 flex flex-col lg:flex-row lg:items-end'>
